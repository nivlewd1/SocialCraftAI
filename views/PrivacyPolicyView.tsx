...
const PrivacyPolicyView: React.FC = () => {
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            {/* Quick Summary Box */}
            <div className="glass-card rounded-lg p-6 bg-soft-blue/10 border-2 border-soft-blue/30">
                <div className="flex items-start space-x-3">
                    <Lock className="h-6 w-6 text-soft-blue flex-shrink-0 mt-1" />
                    <div>
                        <h3 className="font-bold text-surface-900 mb-2">Privacy at a Glance</h3>
            ...
            <div className="glass-card rounded-lg p-8 md:p-12 space-y-8">
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">2. Information We Collect</h2>

                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">2.1 Information You Provide</h3>
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">2.2 Automatically Collected Information</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">2.3 Third-Party Information</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">3. How We Use Your Information</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">4. How We Share Your Information</h2>
                    <p className="text-gray-700 mb-3">We share your information with:</p>

                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">4.1 Service Providers</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">4.2 Legal Requirements</h3>
                     <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">4.3 Business Transfers</h3>
                     <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">5. Data Storage & Security</h2>

                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">5.1 Storage Location</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">5.2 Security Measures</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">5.3 Data Retention</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">6. Your Rights</h2>

                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">6.1 GDPR Rights (EU Users)</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">6.2 CCPA Rights (California Users)</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">6.3 Exercising Your Rights</h3>
                    <p className="text-gray-700">Email: privacy@socialcraftai.com. We will respond within 30 days.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">7. Cookies & Tracking</h2>

                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">7.1 Cookies We Use</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    ...
                    <h3 className="text-xl font-semibold text-surface-900 mb-3 mt-4">7.2 Cookie Management</h3>
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">8. Third-Party Services</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">9. Children's Privacy</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">10. International Users</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold font-display text-surface-900 mb-4">11. Changes to This Policy</h2>
