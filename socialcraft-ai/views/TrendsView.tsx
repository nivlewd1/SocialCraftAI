        ...
        <div className="space-y-8">
            <div className="text-center">
                <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">
                    Real-Time <span className="gradient-text-emerald">TrendSpotter</span>
                </h1>
            ...
            <div className="max-w-4xl mx-auto glass-card rounded-2xl p-8 space-y-6">
                <textarea
                    ...
                    className="w-full h-32 p-4 rounded-lg transition-all text-deep-charcoal placeholder-gray-500 resize-none input-field"
                />
            ...
            {trendResults && (
                <div className="max-w-4xl mx-auto mt-8 animate-fade-in space-y-8">
                    ...
                    <div className="glass-card rounded-lg p-6">
                         ...
                         <p className="text-gray-700 leading-relaxed">{trendResults.overallSummary}</p>
                    </div>
